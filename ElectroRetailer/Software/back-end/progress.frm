...
C.Execute ("CREATE TABLE ER_MASTER_EMPLOYEE(E_ID CHAR(10),E_NAME VARCHAR(30) NOT NULL,E_FNAME VARCHAR(30)NOT NULL, DOB CHAR(10) NOT NULL,E_MOB CHAR(10)NOT NULL,E_ADHAAR CHAR(16) NOT NULL,E_DOJ CHAR(10) NOT NULL,E_ADD VARCHAR(100)NOT NULL,E_QUL VARCHAR(30) NOT NULL,E_EXP CHAR(2), E_POST VARCHAR(30) NOT NULL,E_LEAVE CHAR(1), E_SALARY DECIMAL(5) DEFAULT 0,CONSTRAINT PK_E_ID PRIMARY KEY(E_ID))")
