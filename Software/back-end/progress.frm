...
C.Execute ("CREATE TABLE ER_MASTER_COMPANY_DETAILS(NAME VARCHAR(30) NOT NULL,COMPANY_NAME VARCHAR(50) NOT NULL, BRANCH_NAME VARCHAR(30),GSTNO CHAR(15) NOT NULL,PAN CHAR(10) NOT NULL, MOBILE_NO CHAR(10) NOT NULL,EMAIL VARCHAR(50), DESCRIPTION VARCHAR(100),ADDRESS VARCHAR(100) NOT NULL, CITY VARCHAR(20) NOT NULL, STATE VARCHAR(30) NOT NULL,PINCODE CHAR(6),CONSTRAINT PK_B_N PRIMARY KEY(BRANCH_NAME))")
'CREATINT ACCOUNT
prg ("Creating accounts table")
C.Execute ("CREATE TABLE ER_MASTER_ACCOUNT(YEAR CHAR(4),MONTH CHAR(3), BALANCE DECIMAL(15,2) DEFAULT 0, LOAN DECIMAL(15,2) DEFAULT 0, INCOME DECIMAL(15,2) DEFAULT 0, EXPENSE DECIMAL(15,2) DEFAULT 0, CONSTRAINT PK_ACC_YR_MON PRIMARY KEY(YEAR, MONTH))")
...
C.Execute ("CREATE TABLE ER_MASTER_CUSTOMER(C_ID VARCHAR(10),C_NAME VARCHAR(30) NOT NULL, C_MOBILE CHAR(10) UNIQUE NOT NULL, C_EMAIL VARCHAR(50),C_GSTNO CHAR(15), C_ADDR VARCHAR(100) NOT NULL,CONSTRAINT PK_C_ID PRIMARY KEY(C_ID))")
'CREATE SELL INVOICE
